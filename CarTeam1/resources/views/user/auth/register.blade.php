                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name1" class="col-md-4 col-form-label text-md-right">{{ __('苗字') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="name2" class="col-md-4 col-form-label text-md-right">{{ __('名前') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="furi1" class="col-md-4 col-form-label text-md-right">{{ __('苗字(フリガナ)') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="furi2" class="col-md-4 col-form-label text-md-right">{{ __('名前(フリガナ)') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="name3" class="col-md-4 col-form-label text-md-right">{{ __('ニックネーム') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="tel" class="col-md-4 col-form-label text-md-right">{{ __('電話番号(ハイフン有り)') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="address2" class="col-md-4 col-form-label text-md-right">{{ __('市町村') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="address3" class="col-md-4 col-form-label text-md-right">{{ __('区以降') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="birthday" class="col-md-4 col-form-label text-md-right">{{ __('誕生日(数字のみ)') }}</label>
